<x-guest-layout>
    <style>
        ...
        .login-right img {
            ...
            left: 0;
            z-index: 1;
            opacity: 0.6; /* Dejar que el fondo se mezcle */
    ...
    <section class="login-content p-0 m-0">
        <div class="row m-0 vh-100 w-100">
            ...
            <div class="col-12 col-md-5 col-lg-4 d-flex align-items-center justify-content-center login-left">
                ...
                <svg class="floating-shape" style="top: -50px; left: -50px;" width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-100 px-4 px-md-5" style="max-width: 450px;">
                    ...
                    <div class="text-center mb-5">
                        <div class="d-inline-block text-clinical heartbeat-icon mb-3">
                            <svg width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="text-secondary mb-4" style="font-size: 0.9rem;">Por favor, ingresa tus credenciales de acceso institucional.</p>
                    ...
                    <form method="POST" action="{{ route('login.post') }}" data-toggle="validator">
                        ...
                        <div class="form-group mb-4">
                            <label for="login" class="form-label fw-medium text-dark small mb-1">Usuario / Email</label>
                            <input id="login" type="text" name="login"
                                value="{{ env('IS_DEMO') ? 'admin' : old('login') }}"
                                class="form-control form-control-modern" placeholder="Ej. dr.perez@hospital.com" required autofocus>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="customCheck1" name="remember" style="cursor:pointer;">
                                <label class="form-check-label text-secondary small" for="customCheck1" style="cursor:pointer;">Recordarme</label>
                            </div>
                            {{-- <a href="#" class="text-decoration-none small text-primary fw-medium">¿Olvidaste tu contraseña?</a> --}}
                        </div>

                        <div class="d-grid mt-2">
                            <button type="submit" class="btn btn-primary btn-modern text-white shadow-sm d-flex justify-content-center align-items-center">
                                Ingresar al Sistema
            ...
            <div class="col-12 col-md-7 col-lg-8 d-none d-md-block p-0 login-right">
                ...
                <div class="login-right-content">
                    <div style="max-width: 600px;">
                        <span class="badge bg-white text-primary px-3 py-2 rounded-pill mb-3 fw-bold" style="letter-spacing: 1px;">TECNOLOGÍA AVANZADA</span>
                        ...
                        <p class="text-white-50 fs-5 mb-0" style="line-height: 1.6;">
                            ArrhythmiaAI asiste a los profesionales de la salud en la detección temprana y clasificación precisa de anomalías cardíacas a través de análisis profundo de ECG.
                        </p>
                        
                        <div class="mt-5 d-flex gap-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-white bg-opacity-25 rounded-circle p-2 me-3">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>
                                </div>
                                <div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="bg-white bg-opacity-25 rounded-circle p-2 me-3">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                                </div>
                                <div>
