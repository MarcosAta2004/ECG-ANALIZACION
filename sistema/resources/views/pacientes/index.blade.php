                    ...
                    <table class="table table-striped mb-0" role="grid">
                        ...
                        <tbody>
                            @forelse($pacientes as $paciente)
                                ...
                                <div class="modal fade" id="editPacienteModal{{ $paciente->paciente_id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('pacientes.update', $paciente->paciente_id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Editar Paciente: {{ $paciente->codigo_generado }}</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="fecha_nacimiento" value="{{ $paciente->fecha_nacimiento ? \Carbon\Carbon::parse($paciente->fecha_nacimiento)->format('Y-m-d') : '' }}" max="{{ date('Y-m-d') }}">
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                        ...
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="peso" value="{{ $paciente->peso }}" step="0.01" min="0" max="300" placeholder="Ej. 70.5">
                                                        </div>
                                                        
                                                        <div class="col-md-12 form-group">
                                                            <div class="form-check form-switch mt-2">
                                                                <input class="form-check-input" type="checkbox" id="estadoEdit{{ $paciente->paciente_id }}" name="estado" value="1" {{ $paciente->estado == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="estadoEdit{{ $paciente->paciente_id }}">Paciente Activo</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deletePacienteModal{{ $paciente->paciente_id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('pacientes.destroy', $paciente->paciente_id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-warning d-flex align-items-center mb-0" role="alert">
                                                        ...
                                                        <div>
                                                            ¿Estás seguro que deseas <strong>desactivar</strong> al paciente <strong>{{ $paciente->codigo_generado }}</strong>?
                                                        </div>
                                                    </div>
                                                </div>  
                                                <div class="modal-footer">
                                ...
                                <!-- Activate Modal -->
                                <div class="modal fade" id="activatePacienteModal{{ $paciente->paciente_id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('pacientes.activar', $paciente->paciente_id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-info d-flex align-items-center mb-0" role="alert">
                                                        ...
                                                        <div>
                                                            ¿Estás seguro que deseas <strong>activar</strong> al paciente <strong>{{ $paciente->codigo_generado }}</strong>?
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="form-check form-switch mt-2">
                                ...
                                <label class="form-check-label" for="estadoCreate">Paciente Activo</label>
                            </div>
                        </div>
                    </div>
                </div>
