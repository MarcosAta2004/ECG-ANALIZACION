...
@endcan
                ...
                <div class="card-body border-bottom pb-3">
                    <form method="GET" action="{{ route('niveles-gravedad.index') }}" class="d-flex gap-2 align-items-center">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" name="search"
                                ...
                                placeholder="Buscar por nombre del nivel..."
                                autocomplete="off">
                            @if(request('search'))
                                <a href="{{ route('niveles-gravedad.index') }}" class="btn btn-outline-secondary" title="Limpiar búsqueda">
                    ...
                    @if(request('search'))
                        <div class="mt-2">
                            <small class="text-muted">
                                ...
                                — {{ $niveles->total() }} resultado(s) encontrado(s).
                            </small>
                        </div>
                    @endif
                </div>
...
@endcan
                                    ...
                                    <!-- Edit Modal for Nivel -->
                                    <div class="modal fade" id="editNivelModal{{ $nivel->nivel_id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('niveles-gravedad.update', $nivel->nivel_id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-12 form-group">
                                                                <label class="form-label">Nombre del Nivel <span
                                    ...
                                    <div class="modal fade" id="deleteNivelModal{{ $nivel->nivel_id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('niveles-gravedad.destroy', $nivel->nivel_id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-header">
                                    ...
                                    <!-- Activate Modal -->
                                    <div class="modal fade" id="activateNivelModal{{ $nivel->nivel_id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('niveles-gravedad.activar', $nivel->nivel_id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="alert alert-info d-flex align-items-center mb-0"
                                                            ...
                                                            <div>
                                                                ¿Estás seguro que deseas <strong>activar</strong> el nivel
                                                                <strong>{{ $nivel->nombre }}</strong>?
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">No hay niveles de gravedad
                                            registrados</td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('niveles-gravedad.store') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="createNivelModalLabel">Añadir Nuevo Nivel de Gravedad</h5>
