<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
  <div class="container-fluid navbar-inner">
    <a href="{{ route('dashboard') }}" class="navbar-brand d-lg-none">
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-primary">
          <path d="M20.42 4.58a5.4 5.4 0 0 0-7.65 0l-.77.78-.77-.78a5.4 5.4 0 0 0-7.65 0C1.46 6.7 1.33 10.28 4 13l8 8 8-8c2.67-2.72 2.54-6.3.42-8.42z"></path>
          <polyline points="3 12 7 12 10 5 14 19 17 12 21 12" stroke="#dc3545"></polyline>
      </svg>
      <h4 class="logo-title ms-2 mb-0">ArrhythmiaAI</h4>
    </a>
        ...
        <li class="nav-item dropdown">
          ...
          <img src="{{asset('images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
            <div class="caption ms-3 d-none d-md-block ">
              <h6 class="mb-0 caption-title">{{ auth()->check() ? auth()->user()->nombres . ' ' . auth()->user()->apellido_paterno : 'Invitado' }}</h6>
              <p class="mb-0 caption-sub-title text-capitalize">{{ auth()->check() ? (auth()->user()->rolesa->name ?? 'Especialista') : 'Rol no asignado' }}</p>
            </div>
          </a>
