<ul class="navbar-nav iq-main-menu" id="sidebar">
            ...
            <a class="nav-link" aria-current="page" href="{{ route('imagenes.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 21C7.5 17.25 4.5 14.25 4.5 10.5A4.5 4.5 0 0 1 12 7a4.5 4.5 0 0 1 7.5 3.5c0 3.75-3 6.75-7.5 10.5Z" />
                    </svg>
                </i>
    ...
    @canany(['niveles-gravedad.index', 'grupos-cardiacos.index', 'clasificaciones-arritmia.index'])
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#mantenimiento-collapse" role="button" aria-expanded="false"
                ...
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" width="20">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M10.34 15.84c-.688-.06-1.386-.054-2.066.015a3.5 3.5 0 0 1-3.21-1.58A3.5 3.5 0 0 1 4.5 10.5a3.5 3.5 0 0 1 6.541-1.745c.074.68.08 1.383.018 2.073m-1.72 1.708a2.25 2.25 0 0 0 3.181 3.181l4.243-4.243a2.25 2.25 0 0 0-3.182-3.182l-4.242 4.244Z" />
                    </svg>
                </i>
            ...
            <ul class="sub-nav collapse" id="mantenimiento-collapse" data-bs-parent="#sidebar">
                ...
                @can('clasificaciones-arritmia.index')
                    <li class="nav-item">
    ...
    @can('auditoria.index')
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{ route('auditoria.index') }}">
                <i class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" width="20">
                        <path stroke-linecap="round" stroke-linejoin="round"
