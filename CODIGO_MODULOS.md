# Codigo de modulos del proyecto ECG

Archivo generado para compartir el codigo fuente con una IA y apoyar la metodologia cascada.

> No incluye dependencias, cache, assets compilados, archivos binarios ni modelos entrenados.
...
def predecir_con_modelo(tensor, signals, age, sex, weight):
    """Realiza la predicción con el modelo (ECG + metadata)."""
    print("\n[7/7] Ejecutando predicción con el modelo...")

    model = _cargar_modelo()

    meta = normalizar_metadata_paciente(age, sex, weight)
    probs = model.predict([tensor, meta], verbose=0)[0]
...
## sistema/database/factories/UserFactory.php
...
## sistema/lang/es/pagination.php
